...
NOverlap.propTypes = {
	nodes: require('react').PropTypes.arrayOf(require('react').PropTypes.any),
	nodeMargin: require('react').PropTypes.number,
	scaleNodes: require('react').PropTypes.number,
	gridSize: require('react').PropTypes.number,
	permittedExpansion: require('react').PropTypes.number,
	speed: require('react').PropTypes.number,
	maxIterations: require('react').PropTypes.number,
